...
<CardGroup cols={2}>
  <Card title="hover" icon="arrow-pointer" href="/api-reference/hover">
    Move cursor to element center or coordinates
  </Card>
  <Card title="drag" icon="hand" href="/api-reference/drag">
    Drag from one element or point to another
  </Card>
  <Card title="mouse-move" icon="arrows" href="/api-reference/mouse-move">
    Move cursor to absolute screen coordinates
  </Card>
  <Card title="mouse-click" icon="hand-pointer" href="/api-reference/mouse-click">
    Click at absolute screen coordinates
  </Card>
  <Card title="mouse-down" icon="hand-point-down" href="/api-reference/mouse-down">
    Press mouse button at coordinates (without releasing)
  </Card>
  <Card title="mouse-up" icon="hand-point-up" href="/api-reference/mouse-up">
