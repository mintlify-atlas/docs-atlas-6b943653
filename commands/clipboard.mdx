...
<CardGroup cols={2}>
  <Card title="clipboard-get" icon="clipboard" href="/api/clipboard-get">
    Read plain-text clipboard contents
  </Card>
  <Card title="clipboard-set" icon="clipboard-check" href="/api/clipboard-set">
    Write text to the clipboard
  </Card>
  <Card title="clipboard-clear" icon="clipboard-slash" href="/api/clipboard-clear">
    Clear the clipboard
  </Card>
</CardGroup>
