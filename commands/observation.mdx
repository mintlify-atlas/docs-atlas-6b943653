...
<CardGroup cols={2}>
  <Card title="snapshot" icon="camera" href="/api-reference/snapshot">
    Capture accessibility tree with @ref IDs
  </Card>
  <Card title="find" icon="magnifying-glass" href="/api-reference/find">
    Search elements by role, name, value, or text
  </Card>
  <Card title="screenshot" icon="image" href="/api-reference/screenshot">
    Take PNG screenshot of application window
  </Card>
  <Card title="get" icon="download" href="/api-reference/get">
    Read element property (text, value, bounds, role)
  </Card>
  <Card title="is" icon="circle-check" href="/api-reference/is">
    Check boolean state (visible, enabled, checked, focused)
  </Card>
  <Card title="list-surfaces" icon="list" href="/api-reference/list-surfaces">
