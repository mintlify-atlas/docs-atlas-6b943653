...
<CardGroup cols={2}>
  <Card title="click" icon="hand-pointer" href="/api/click">
    Click element via accessibility press action
  </Card>
  <Card title="double-click" icon="hand-pointer" href="/api/double-click">
    Double-click to open files or select words
  </Card>
  <Card title="triple-click" icon="hand-pointer" href="/api/triple-click">
    Triple-click to select lines or paragraphs
  </Card>
  <Card title="right-click" icon="hand-pointer" href="/api/right-click">
    Right-click to open context menu
  </Card>
  <Card title="type" icon="keyboard" href="/api/type">
    Focus element and type text
  </Card>
  <Card title="set-value" icon="pen" href="/api/set-value">
    Set value directly via accessibility attribute
  </Card>
  <Card title="clear" icon="eraser" href="/api/clear">
    Clear element value to empty string
  </Card>
  <Card title="focus" icon="bullseye" href="/api/focus">
    Set keyboard focus on element
  </Card>
  <Card title="select" icon="check" href="/api/select">
    Select option in dropdown or list
  </Card>
  <Card title="toggle" icon="toggle-on" href="/api/toggle">
    Toggle checkbox or switch
  </Card>
  <Card title="check" icon="square-check" href="/api/check">
    Set checkbox to checked (idempotent)
  </Card>
  <Card title="uncheck" icon="square" href="/api/uncheck">
    Set checkbox to unchecked (idempotent)
  </Card>
  <Card title="expand" icon="chevron-down" href="/api/expand">
    Expand disclosure or tree item
  </Card>
  <Card title="collapse" icon="chevron-up" href="/api/collapse">
    Collapse disclosure or tree item
  </Card>
  <Card title="scroll" icon="arrows-up-down" href="/api/scroll">
    Scroll element in a direction
  </Card>
  <Card title="scroll-to" icon="arrow-down-to-line" href="/api/scroll-to">
