...
<CardGroup cols={2}>
  <Card title="launch" icon="rocket" href="/api-reference/launch">
    Launch application and wait for window
  </Card>
  <Card title="close-app" icon="xmark" href="/api-reference/close-app">
    Quit application gracefully or force kill
  </Card>
  <Card title="list-windows" icon="window-restore" href="/api-reference/list-windows">
    List all visible windows (filter by app)
  </Card>
  <Card title="list-apps" icon="list" href="/api-reference/list-apps">
    List all running GUI applications
  </Card>
  <Card title="focus-window" icon="bullseye" href="/api-reference/focus-window">
    Bring window to front
  </Card>
  <Card title="resize-window" icon="expand" href="/api-reference/resize-window">
    Resize application window
  </Card>
  <Card title="move-window" icon="arrows" href="/api-reference/move-window">
    Move window to new position
  </Card>
  <Card title="minimize" icon="window-minimize" href="/api-reference/minimize">
    Minimize application window
  </Card>
  <Card title="maximize" icon="window-maximize" href="/api-reference/maximize">
    Maximize or zoom application window
  </Card>
  <Card title="restore" icon="window-restore" href="/api-reference/restore">
