...
<CardGroup cols={2}>
  <Card title="press" icon="keyboard" href="/api-reference/press">
    Send key combo (return, escape, cmd+s, shift+tab)
  </Card>
  <Card title="key-down" icon="down" href="/api-reference/key-down">
    Hold a key or modifier down
  </Card>
  <Card title="key-up" icon="up" href="/api-reference/key-up">
