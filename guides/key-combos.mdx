...
- [key-down](/commands/keyboard/key-down) - Hold a key or modifier
- [key-up](/commands/keyboard/key-up) - Release a held key or modifier
- [type](/commands/interaction/type) - Type text into an element