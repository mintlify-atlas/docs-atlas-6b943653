...
- [Installation](/getting-started/installation) - Platform-specific installation instructions
- [Permissions](/getting-started/permissions) - Grant accessibility permissions
- [Architecture](/core-concepts/architecture) - Cross-platform design